...
public class CadastroParticipanteService {
	...
	private Participantes participantes; // Repositório de produtos, será necessário para salvar o produto
	
	@Transactional // Abre uma transação quando for iniciar a execução do método salvar
	public void salvar(Participante participante) {
		participantes.save(participante); // No repositório produtos
	}
